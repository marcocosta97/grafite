...
public:
    ...
    ef_sux_vector(const t_itr begin, const t_itr end, const bool remove_duplicates = true) : ef(begin, end, remove_duplicates) {}
...
public:
    ...
    inline bool query(const value_type left, const value_type right) const
    {
        ...
        if (r > last) return bv.check_presence(l, last);
