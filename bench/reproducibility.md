...
sh ../grafite/bench/scripts/generate_datasets.sh ../grafite real_datasets
```
...
- Figure 2. `lemma_test.pdf`
- Figure 3. `fpr_test.pdf`
- Figure 4. `fpr_real_test.pdf`
- Figure 5. `corr_test.pdf`
- Figure 6. `true_test.pdf`
- Figure 7. `constr_time_test.pdf`
- Figure 8. `bucketing_test.pdf`
